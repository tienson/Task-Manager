    ...
    function(editableDirectiveFactory, $injector, $parse) {
        ...
        return editableDirectiveFactory({
            ...
            render: function() {
                ...
                var inputDatePicker = angular.element('<input type="text" style="width:160px;" class="form-control" ng-model="$parent.$data"/>');
...
angular.module('xeditable').directive('editableCombodate', ['editableDirectiveFactory', 'editableCombodate',
  function(editableDirectiveFactory, editableCombodate) {
    return editableDirectiveFactory({
      ...
      inputTpl: '<input type="text" style="width:160px;" >',
      render: function() {
        this.parent.render.call(this);
    ...
    angular.module('xeditable').directive(directiveName, ['editableDirectiveFactory',
      function(editableDirectiveFactory) {
        return editableDirectiveFactory({
          ...
          inputTpl: ' <br> <input type="'+type+'" style="width:160px;" >',
          render: function() {
            this.parent.render.call(this);
