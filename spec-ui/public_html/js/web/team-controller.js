...
ngapp.controller('ticketTeamCtrl', function ($rootScope, $state, $scope, $http, $window, Notification, authsession) {
...
//    alert($scope.statusSelect);
    $scope.getMeTickets = function () {
        httpApiGet($http, 'ticket/team', function ($response) {
...
//                console.log($response.data.tickets.length);
                if ($response.data.tickets.length == null) {
